                            ...
                            <div className="px-4 py-5 sm:p-6">
                                ...
                                </h3>
                                {
                                    credentials.length == 0 ? (
                                        ...
                                        <div className="mt-2 max-w-xl text-sm text-gray-500">
                                            <p>
                                                To add more calendar integrations, head over to the integrations page, and click the add link to initiate the process.
                                            </p>
                                        </div>
                                    )
                                }
                                ...
                                <div className="mt-3 text-sm">
                                    <Link href="/integrations">
                                        <a className="font-medium text-blue-600 hover:text-blue-500"> Set up your {credentials.length == 0 ? 'first' : 'next'} integration <span aria-hidden="true">&rarr;</span></a>
                                    </Link>
                                </div>
                            </div>
                        </div>
...
export const getServerSideProps = async (context: any) => {
    ...
    if (session) {
        // todo - move this code to the server-side and abstract the round trip
