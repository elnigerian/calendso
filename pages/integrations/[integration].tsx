...
const Integration = (props: any) => {
    ...
    const deleteIntegrationHandler = async (event: any) => {
    ...
    return(
        <div>
            <Head>
                <title>{getIntegrationName(props.integration.type)} | Integrations | Schedularly</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>

            <Layout heading={getIntegrationName(props.integration.type)}>
